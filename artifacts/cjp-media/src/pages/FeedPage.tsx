                    ...
                    <Link key={post.id} href={`/post/${post.id}`} className="block group">
                      <div className="px-4 py-5 hover:bg-white/[0.02] transition-colors">
                        ...
                        <div className="flex items-center gap-3 mb-4">
                          <div className="w-10 h-10 rounded-full bg-[#4d6600] flex items-center justify-center shrink-0 border border-[#ccff00]/30">
                            {profile?.avatarUrl ? (
                              <img src={profile.avatarUrl} alt="Author" className="w-full h-full rounded-full object-cover" />
                            ) : (
                        ...
                        {/* Title */}
                        <h2 className="text-white font-bold text-[16px] leading-snug mb-3 group-hover:text-[#ccff00] transition-colors">
                          {post.title}
                        </h2>
